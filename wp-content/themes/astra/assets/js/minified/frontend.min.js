...
( () => {
    ...
    function e(e) {
        ...
        "dropdown" === c && (document.getElementById("ast-mobile-popup").classList.remove("active", "show"),
        g("updateHeader")),
        "off-canvas" === c && e.forEach(function(e) {
    ...
    function t(e) {
        ...
        if (void 0 === e && null !== d)
            if (m = d.querySelector("#ast-mobile-header"))
                e = m.dataset.type;
            else {
                        ...
                        astra.is_header_footer_builder_active && ( () => {
                            ...
                            t && (t.forEach(e => {
                                e.addEventListener("keydown", function(o) {
                                    if ("Enter" === o.key) {
                                        /Mobi|Android|iPad|iPhone/i.test(navigator.userAgent) && (o.preventDefault(),
                                        o.stopPropagation());
    ...
    n = k.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i) || [],
    /trident/i.test(n[1]) ? a = /\brv[ :]+(\d+)/g.exec(k) || [] : "Chrome" === n[1] && null != (a = k.match(/\bOPR|Edge\/(\d+)/)) || (n = n[2] ? [n[1], n[2]] : [navigator.appName, navigator.appVersion, "-?"],
    ...
    astra.is_scroll_to_id) {
        let o = e => {
          ...
          , t = (e, t=null) => {
            ...
            n && (0 < (n = n.querySelectorAll("div[data-stick-support]")).length ? n.forEach(e => a += e.clientHeight) : "undefined" == typeof astraAddon || Number(astraAddon.sticky_hide_on_scroll) && !document?.querySelector(".ast-header-sticked") || (n = document.querySelector("#ast-fixed-header")) && (a = n?.clientHeight,
            Number(astraAddon?.header_main_shrink)) && (n?.querySelectorAll(".ast-above-header-wrap, .ast-below-header-wrap"))?.forEach( () => a -= 10),
            n = t || e.target?.closest("a").hash) && (t = document.querySelector(n)) && (t = (n = o(t)) - (a = "undefined" != typeof astraAddon && Number(astraAddon.sticky_hide_on_scroll) && window?.scrollY < n ? 0 : a)) && astraSmoothScroll(e, t)
        }
          , s = [];
        ...
        if (k)
            for (let e of k)
                e.href.split("#")[0] !== location.href.split("#")[0] ? s.push({
                    hash: e.hash,
                    url: e.href.split("#")[0]
    ...
    astra?.is_dark_palette ? document.documentElement.classList.add("astra-dark-mode-enable") : document.documentElement.classList.remove("astra-dark-mode-enable"),
    window.addEventListener("DOMContentLoaded", e => {
        ...
        document.querySelector(".woocommerce-store-notice__dismiss-link")?.addEventListener("click", () => {
            "undefined" != typeof wp && wp?.customize || (document.body.classList.remove("ast-woocommerce-store-notice-hanged"),
